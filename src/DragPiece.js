...
export default class extends React.Component{
    ...
    render(){
        return (<React.Fragment>
            ...
            <div style={{width :500, height: 15, backgroundColor: 'black', left: -100, position: 'absolute'}}></div>
            {/* <div style={{height: 500, width: 15, backgroundColor: 'black', top: -100, position: 'absolute'}}></div>
